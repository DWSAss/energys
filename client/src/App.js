...
function Apps() {
  ...
  const leftModalContent = [
    ...
    },
    {
      ...
      content: (
        <>
          Ответ: Вряд ли вы запомните, вам нужно записать контактные данные мастера и номер счётчика, который вы свертие в документах. Если у вас нет под рукой листа с ручкой можете записать в телефоне. Постарайтесь найти, я ожидаю Вас.
        </>
      )
    },
    {
  ...
  const rightModalContent = [
    ...
    {
      id: "modal12",
      title: "У васть мои данные я не могу вам ничего давать",
      content: (
        <>
